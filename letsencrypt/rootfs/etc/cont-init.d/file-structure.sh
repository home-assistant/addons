...
echo -e "dns_cloudxns_api_key = $(bashio::config 'dns.cloudxns_api_key')\n" \
      ...
      "certbot_dns_cpanel:cpanel_url = $(bashio::config 'dns.cpanel_url')\n" \
      "certbot_dns_cpanel:cpanel_username = $(bashio::config 'dns.cpanel_username')\n" \
      "certbot_dns_cpanel:cpanel_password = $(bashio::config 'dns.cpanel_password')\n" \
